# BLM/RDM Fast Cast Reference

Targeting the **80% Hard Cap** for Precast sets.
...
* Idle in (partial) FC gear where possible to ensure Midcast gear registers without lockout failures.
